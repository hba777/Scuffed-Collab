                      ...
                      Column(
                        children: [
                          ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: filteredProjects.isNotEmpty ? filteredProjects.length : successState.projects.length,
                            itemBuilder: (context, index) {
                              // Show filtered projects if there are any, else show all projects
                              final project = filteredProjects.isNotEmpty ? filteredProjects[index] : successState.projects[index];
                              return InkWell(
                                onTap: () {
                                ...
                                child: ProjectCard(
                                  ...
                                  projectCreatedAt: MyDateUtil.getFormattedDateTime(context: context, time: project.createdAt),
                                ),
                              );
                            },
                          ),
